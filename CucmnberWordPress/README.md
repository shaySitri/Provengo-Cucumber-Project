# Testing WordPress using Provengo
...
8. We copied the generated graph of the model to a file named [wordpress.pdf](model.pdf) inside this directory (the link should work).

### Story files
The test stories are in [Tests.story.js](WordPress/spec/js/OrderPizza.story.js). See the file for a detailed description of the stories.
